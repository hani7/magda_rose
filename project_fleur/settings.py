"""
Django settings for project_fleur project.
...
TEMPLATES = [
    {
        ...
        "DIRS": [],  # or add extra template dirs if you use them
...
# project_fleur/settings.py
LOGIN_URL = "fleur:bo_login"
LOGIN_REDIRECT_URL = "fleur:bo_dashboard"
LOGOUT_REDIRECT_URL = "fleur:bo_login"
